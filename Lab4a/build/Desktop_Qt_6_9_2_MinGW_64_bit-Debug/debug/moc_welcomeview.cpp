...
template <> constexpr inline auto WelcomeView::qt_create_metaobjectdata<qt_meta_tag_ZN11WelcomeViewE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'goDepartmentView'
        QtMocHelpers::SignalData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'goDoctorView'
        QtMocHelpers::SignalData<void()>(3, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'goPatientView'
...
void WelcomeView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (WelcomeView::*)()>(_a, &WelcomeView::goDepartmentView, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (WelcomeView::*)()>(_a, &WelcomeView::goDoctorView, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (WelcomeView::*)()>(_a, &WelcomeView::goPatientView, 2))
            return;
    }
}
