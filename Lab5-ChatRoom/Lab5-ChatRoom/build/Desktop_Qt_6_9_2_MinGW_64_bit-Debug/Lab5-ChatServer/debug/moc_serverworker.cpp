...
template <> constexpr inline auto ServerWorker::qt_create_metaobjectdata<qt_meta_tag_ZN12ServerWorkerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'jsonReceived'
        QtMocHelpers::SignalData<void(ServerWorker *, const QJsonObject &)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void ServerWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ServerWorker::*)(const QString & )>(_a, &ServerWorker::logMessage, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ServerWorker::*)()>(_a, &ServerWorker::disconnectedFromClient, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (ServerWorker::*)(ServerWorker * , const QJsonObject & )>(_a, &ServerWorker::jsonReceived, 2))
            return;
    }
}
